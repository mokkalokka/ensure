...
public class AccidentStatementBuilderMedExceptions {
    ...
    public AccidentStatementBuilderMedExceptions setRegisteredTo(String registeredTo) throws BuilderInputException {
    ...
    public AccidentStatementBuilderMedExceptions setAccidentNr(String accidentNr) throws BuilderInputException {
    ...
    public AccidentStatementBuilderMedExceptions setDateOfAccident(String dateOfAccident) throws BuilderInputException {
    ...
    public AccidentStatementBuilderMedExceptions setAccidentType(String accidentType) throws BuilderInputException {
    ...
    public AccidentStatementBuilderMedExceptions setAccidentDescription(String accidentDescription) throws BuilderInputException {
    ...
    public AccidentStatementBuilderMedExceptions setAppraisalAmount(String appraisalAmount) throws BuilderInputException {
    ...
    public AccidentStatementBuilderMedExceptions setDispersedCompensation(String dispersedCompensation) throws BuilderInputException {
